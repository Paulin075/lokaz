    ...
    const handleConfirmReservation = async (reservationData: any) => {
      ...
      try {
        ...
        toast({
          ...
          description: "Votre réservation Chap-Chap a été enregistrée avec succès",
        })
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Location à l'heure ou à la journée. Réservez instantanément pour vos besoins urgents : 
              bureaux, salles de réunion, logements courts séjours.
            </p>
          </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold font-baloo">
              {chambres.length} espace{chambres.length !== 1 ? 's' : ''} Chap-Chap disponible{chambres.length !== 1 ? 's' : ''}
            </h2>
            <div className="flex items-center gap-2">
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="prix_heure_asc">Prix/heure croissant</SelectItem>
                  <SelectItem value="prix_heure_desc">Prix/heure décroissant</SelectItem>
                  <SelectItem value="prix_jour_asc">Prix/jour croissant</SelectItem>
                  <SelectItem value="prix_jour_desc">Prix/jour décroissant</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
