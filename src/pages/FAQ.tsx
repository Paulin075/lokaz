...
const FAQ = () => (
  <div className="max-w-3xl mx-auto py-16 px-4 font-baloo">
    <h1 className="text-3xl md:text-4xl font-bold text-lokaz-orange mb-8 text-center">
      Foire Aux Questions (FAQ)
    </h1>
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-lokaz-black mb-2">
          Comment puis-je réserver un logement sur NBBC Immo ?
        </h2>
      ...
      <div>
        <h2 className="text-xl font-semibold text-lokaz-black mb-2">
          Comment devenir propriétaire sur NBBC Immo ?
        </h2>
        <p className="text-gray-700">
      ...
      <div>
        ...
        <p className="text-gray-700">
          Vous pouvez nous contacter via l'email immonbbc@gmail.com ou le numéro
          +228 96 20 04 88.
        </p>
      </div>
    </div>
