      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="mb-6">
              <Logo className="h-16 md:h-20 w-auto invert transition-transform hover:scale-105 duration-300" />
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              La première plateforme de gestion immobilière connectée du Togo.
              Trouvez, réservez et gérez vos biens avec Lokaz en toute simplicité.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">contact@lokaz.com</span>
              </div>
            </div>
